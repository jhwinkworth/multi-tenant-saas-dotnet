...
namespace API.Tests.Controllers
{
    public class ProjectControllerTests
    {
        ...
        public void GetAll_ShouldReturnOkWithProjects()
        {
            ...
            {
                new Project { Id = Guid.NewGuid(), Name = "Project 1", CreatedAt = createdAt, TenantId = Guid.NewGuid() },
                new Project { Id = Guid.NewGuid(), Name = "Project 2", CreatedAt = createdAt, TenantId = Guid.NewGuid() }
            };
